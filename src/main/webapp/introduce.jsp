...
<section class="container py-5" id="introduce-shop">
  <div class="row">
    <div class="col-md-12">
      <p>
        <strong>
                    <span style="font-size: 20px">"Sou Coffee" không chỉ là nơi bạn thưởng thức những tách cà phê tinh tế, mà còn là điểm dừng chân lý tưởng để tìm cho mình những món quà ý nghĩa, độc đáo và mới lạ.
                        Chúng tôi tự hào là địa chỉ tin cậy cho những ai muốn tặng những món quà mang ý nghĩa và tình cảm trong những dịp đặc biệt.</span>
        </strong>
      </p>
      <p style="text-align: center; margin-top: 30px">
                <span>
                    <img src="https://cafefcdn.com/203337114487263232/2022/10/17/photo-12-16659958786491022208653.jpg"
                         alt="Cà phê cốm mang đặc trưng của Miền Bắc" style="border-radius: 5px; width: 60%">
                </span>
      </p>
      <p style="text-align: center">
                <span style="font-size:17px; font-weight: 500">
                    <em>Cà phê cốm mang đặc trưng của Miền Bắc</em>
                </span>
      </p>
      <p>
        <strong>
                    <span style="font-size: 18px">
                    Với sứ mệnh "Sou Coffee", chúng tôi tạo ra những giỏ quà xinh đẹp, kết hợp cùng cà phê - biểu tượng của sự yêu thương và ý nghĩa.
                        Mỗi giỏ quà là một tượng trưng của tình yêu thương và sự quan tâm chân thành.
                    </span>
        </strong>
      </p>
      <p>
        <strong>
                    <span style="font-size: 18px">
                        Hãy đồng hành cùng "Sou Coffee" trên hành trình khám phá và chia sẻ những khoảnh khắc đẹp nhất của cuộc sống.
                        Hãy để chúng tôi là người bạn đồng hành trong mỗi kỷ niệm và dịp lễ quan trọng của bạn.
                    </span>
        </strong>
      </p>
      <p>
        <strong>
                    <span style="font-size: 18px">
                        Hãy đến và cảm nhận sự ấm áp và ý nghĩa tại "Sou Coffee" ngay hôm nay!
                    </span>
        </strong>
      </p>
      <p style="text-align: center; margin-top: 30px">
                <span>
                    <img src="https://cdn.tcdulichtphcm.vn/upload/4-2022/images/2022-10-14/1665764276-thumbnail-width750height563-auto-crop-640x335-watermark.jpg" alt="" style="border-radius: 5px; width: 60%">
                </span>
      </p>
      <p style="text-align: center">
                <span style="font-size: 17px; font-weight: 500">
                    <em>Cùng nhau tận hượng hương vị đặc biệt cùng những người thân yêu</em>
                </span>
      </p>
      <p>
        <strong>
      ...
      <p style="text-align: center; margin-top: 30px">
                <span>
                    <img src="https://lh3.googleusercontent.com/proxy/JmhtgYpCxFPv2_lguIXu-mhLgxTCksldrz_Zi8_RO_xLSEJLABwesIv1ooNJJ-Dqv3M-zDOuK0m0tXNgCxnh1jrA3vFzOaMONAakoZcQKioQ9CDzMPXPzTTJXTvv-7o" alt="" style="width: 60%; border-radius: 5px">
                </span>
      </p>
      <p style="text-align: center">
                <span style="font-size: 17px; font-weight: 500">
                    <em>Lưu giữ tình thương yêu đến với mọi người</em>
                </span>
      </p>
    </div>
  </div>
