                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Thu nhập trong tháng</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        ${moneyWithMonth}
                                    </h5>
                                </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Số lượng người dùng vi phạm</p>
                                <h5 class="font-weight-bolder mb-0">
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Thu nhập trong tháng này</p>
                            <h5 class="font-weight-bolder mb-0">
                                ${totalMoneyOnMonth}
                            </h5>
                        </div>
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="text-sm mb-0 text-capitalize font-weight-bold">Thu nhập trong tháng trước</p>
                            <h5 class="font-weight-bolder mb-0">
                                ${totalMoneyBeforeMonth}
                            </h5>
                        </div>
                    </div>
                    <div class="col-4 text-end">
