        ...
        <div class="container-fluid py-1 px-3">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    <form id="searchForm" onsubmit="submitSearch()" action="service-accepted" method="get">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6 class="text-lg">Bảng yêu cầu dịch vụ đang chờ hoàn thành(Trang ${page}/${maxPage})</h6>
                                ...
                                <ul class="pagination">
                                    ...
                                    <c:if test="${page>1}">
                                        ...
                                        <li class="page-item">
                                            ...
                                            <c:if test="${not empty search}">
                                                <a class="page-link" href="service-accepted?page=${page-1}&search=${search}"
                                            </c:if>
                                    ...
                                    <c:forEach var="i" begin="${page-1}" end="${page+1}">
                                        <c:if test="${i>=1&&i<=maxPage}">
                                            ...
                                            <c:if test="${not empty search}">
                                                <li class="page-item"><a
                                                        class="page-link <c:if test="${i eq page}">active text-white</c:if>"
                                                        href="service-accepted?page=${i}&search=${search}">${i}</a></li>
                                            </c:if>
                                        </c:if>
                                    ...
                                    <c:if test="${page<maxPage}">
                                        <li class="page-item">
                                                ...
                                                <c:if test="${not empty search}">
                                                <a class="page-link"
                                                   href="service-accepted?page=${page+1}&search=${search}"
                                                   aria-label="Next">
                                                    </c:if>
