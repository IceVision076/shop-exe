            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Bảng dịch thành công (Trang ${page}/${maxPage})</h6>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                <c:forEach items="${serviceSuccessList}" var="s">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <div>
                                                                <h4>Số tiền khách thanh toán:
                                                                    <span class="text-lg font-weight-bold mb-0" style="color: orange">
                                                                    <fmt:formatNumber type="number"
                                                                                      maxFractionDigits="3" value="${s.price}"/> <span
                                                                        class="text-success">VND</span></span> </h4>
