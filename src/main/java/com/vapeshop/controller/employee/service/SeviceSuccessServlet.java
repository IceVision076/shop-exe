...
public class SeviceSuccessServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        int pageNumber = -1;
        int amountServiceAccept = ServiceResposiory.serviceSuccessAmount();
        ...
        ArrayList<ServiceTracking> serviceSuccessList = ServiceResposiory.serviceSuccessPage(pageNumber);
