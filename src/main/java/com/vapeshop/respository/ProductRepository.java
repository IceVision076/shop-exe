...
public class ProductRepository {
    ...
    public static List<Product> pagingProduct(int index){
        ...
        try ( Connection con = DBConnect.getConnection()) {
            ...
            while (rs.next()) {
                ...
                productList.add(new Product(id,idProductType,productName,typeName,price,brand,detail,origin,imgURL,status));
            }
            con.close();
        } catch (SQLException e) {
            throw new RuntimeException(e);
    ...
    public static void main(String[] args) {
        ArrayList<ProductType> product = ProductRepository.getTypeByID("A00000009");
